...
mapLoop:
    lw t1,0(s0)      # load the address of the array of current node into t1        1
    ...
    mv t0,t4
    addi t0, t0, 1      # increment the count                                       2
    bne t0, t2, mapLoop # repeat if we haven't reached the array size yet

    lw a0, 8(s0)        # load the address of the next node into a0                    3
    mv s1,a1       # put the address of the function back into a1 to prepare for the recursion    4
